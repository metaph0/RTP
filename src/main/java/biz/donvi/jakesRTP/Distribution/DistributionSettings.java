...
public class DistributionSettings {
    ...
    public DistributionSettings(DistributionShape shape, int centerX, int centerZ) {
        this.shape = shape;
    ...
    public DistributionSettings(ConfigurationSection settings) throws JrtpBaseException.ConfigurationException {
