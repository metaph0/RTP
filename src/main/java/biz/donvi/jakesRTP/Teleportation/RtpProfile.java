package biz.donvi.jakesRTP.Teleportation;

import biz.donvi.jakesRTP.Distribution.DistributionSettings;
import biz.donvi.jakesRTP.Exceptions.JrtpBaseException;
import biz.donvi.jakesRTP.SafeLocation.SafeLocationFinder.LocCheckProfiles;
import biz.donvi.jakesRTP.Utils.CoolDownTracker;
...
import static biz.donvi.jakesRTP.Messages.MessageStyles.DebugDisplayLines.*;
import static biz.donvi.jakesRTP.Messages.MessageStyles.enabledOrDisabled;
import static biz.donvi.jakesRTP.Teleportation.RandomTeleporter.EXPLICIT_PERM_PREFIX;
...
public class RtpProfile {
     ...
     */
    public static final RtpProfile DEFAULT_SETTINGS = new RtpProfile(
